    ...
    if (isDockCollapsed) {
        return (
            <button
                ...
                className="fixed bottom-2 left-1/2 -translate-x-1/2 z-50 dock-collapse-bar focus:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--color-ring))] focus-visible:ring-offset-2 rounded-full"
        ...
        >
                    ...
                    >
                        ...
                        <div className="flex items-center gap-3 px-6 py-4 border-b border-[hsl(var(--color-border)/0.3)]">
                            ...
                            <button
                                ...
                                className="p-2 -mr-2 text-[hsl(var(--color-muted-foreground))] hover:bg-[hsl(var(--color-muted)/0.5)] rounded-full transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--color-ring))]"
                            >
                                ...
                                searchResults.map((result, index) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`w-full flex items-center gap-4 px-4 py-3 text-left rounded-xl transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--color-ring))] focus-visible:ring-offset-2 ${index === selectedIndex
            ...
            >
                    ...
                    if (item.href) {
                        return (
                            <Link
                                key={item.id}
                                href={item.href}
                                className={`relative flex items-center justify-center w-14 h-12 rounded-2xl transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--color-ring))] ${isActive
                ...
                <button
                    ...
                    className="flex items-center justify-center w-8 h-8 rounded-xl hover:bg-[hsl(var(--color-muted)/0.5)] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--color-ring))]"
