    ...
    if (isDockCollapsed) {
        return (
            <button
                ...
                className="fixed bottom-2 left-1/2 -translate-x-1/2 z-50 dock-collapse-bar focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--color-ring))] rounded-full"
        ...
        >
                    ...
                    >
                        ...
                        <div className="flex items-center gap-3 px-6 py-4 border-b border-[hsl(var(--color-border)/0.3)]">
                            ...
                            <button
                                ...
                                className="p-2 -mr-2 text-[hsl(var(--color-muted-foreground))] hover:bg-[hsl(var(--color-muted)/0.5)] rounded-full transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--color-ring))]"
                            >
            ...
            >
                ...
                <button
                    ...
                    className="flex items-center justify-center w-8 h-8 rounded-xl hover:bg-[hsl(var(--color-muted)/0.5)] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--color-ring))]"
