...
export const FileUploader: React.FC<FileUploaderProps> = ({
  ...
  const baseStyles = `
    ...
    cursor-pointer
    group
    focus:outline-none focus-within:ring-2 focus-within:ring-[hsl(var(--color-ring))] focus-within:ring-offset-2 focus-within:ring-offset-[hsl(var(--color-background))]
  `;
